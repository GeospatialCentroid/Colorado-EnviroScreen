...
Utilize the following to ensure packages within a specific function are load
```{r}
x <- c("arcpullr","dplyr", "sf" )
lapply(x, require, character.only = TRUE)

```
This should not be necessary for the final product but will be helpful during the development
